...
<div class="panel panel-info">
  ...
  <div class="panel-body collapse" id="education_and_skills">
    <div style="padding-left:15px">
        <i class="fa fa-university" aria-hidden="true"></i> Bachelor of Science: Computer Engineering, <a href="http://ece.iastate.edu" target="_blank" class="small text-muted">Iowa State University</a>
    </div>
    <hr/>
    <div>
    <div class="col-md-4">
...
<div class="panel panel-info">
    ...
    <hr/>
    <h4 class="list-group-item-heading"> Mars Rover <span class="small text-muted">@Embedded Systems</span> </h4>
    <p class=list-group-item-text>
    <ul style="list-style-type:circle;">
    ...
    <hr/>
    <h4 class="list-group-item-heading"> Twitter Data Analysis <span class="small text-muted">@Hadoop Programs</span> </h4>
    <p class=list-group-item-text>
    <ul style="list-style-type:circle;">
    ...
    <h4 class="list-group-item-heading"> Attendance <span class="small text-muted">@Android Application</span> </h4>
    <p class=list-group-item-text>
    <ul style="list-style-type:circle;">
